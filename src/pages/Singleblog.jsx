          ...
          <div className="col-12">
            <div className="single-blog-card">
              ...
              <p className="">
                ...
                esse, eaque, nihil voluptas recusandae dolores labore, deserunt
                iste reprehenderit corporis porro. Repellat cum quo veniam
                voluptates laborum, veritatis porro numquam.
              </p>
            </div>
          </div>
        </div>
